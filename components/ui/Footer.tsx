  ...
  return (
    <footer className="bg-navy-950 border-t border-white/5">
      <div className="container-max section-padding py-12 lg:py-16">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-white/40">
              <li>
                <a
                  ...
                  className="hover:text-aqua-400 transition-colors flex items-center gap-2"
                >
            ...
            <div className="mt-4 flex gap-3">
              <a
                ...
                className="text-white/30 hover:text-aqua-400 transition-colors"
              >
                <InstagramIcon />
              </a>
              <a
        ...
        <div className="mt-12 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/30">
          <p>
